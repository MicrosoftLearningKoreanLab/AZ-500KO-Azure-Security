...
이 실습에서는 PIM(Azure Privileged Identity Management)을 사용하여 사용자를 JIT(Just-in-Time) 관리하도록 설정하고, 권한이 필요한 작업을 수행할 사용자를 제어하는 방법에 대해 알아보십시오. 또한 리소스 수준에서 역할 할당을 할당할 수 있는 PIM의 새로운 기능과 다양한 디렉토리 역할에 대해서도 알아보십시오. 이 실습은 다음 내용을 포함합니다 : 
...
1.  **Azure 포털** **Cloud Shell** 창의 **PowerShell** 세션을 시작한다. 알림창이 뜨면 **스토리지 만들기**를 클릭한다.
